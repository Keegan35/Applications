...
public class MemoryButtonHard extends Button
{
    //Variables
    protected int row;
    ...
    public MemoryButtonHard(Context context, int r, int c, int frontImageDrawableId)
    {
        super(context);
        row = r;
        column = c;
        ...
        params.width = (int) getResources().getDisplayMetrics().density * 54;
        params.height = (int) getResources().getDisplayMetrics().density * 54;
