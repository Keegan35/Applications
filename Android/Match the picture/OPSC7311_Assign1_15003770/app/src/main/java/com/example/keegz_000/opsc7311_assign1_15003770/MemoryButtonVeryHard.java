...
/**
 * Created by keegz_000 on 2017/06/04.
 */

public class MemoryButtonVeryHard extends Button
{
    //Variables
    protected int row;
    ...
    public MemoryButtonVeryHard(Context context, int r, int c, int frontImageDrawableId)
    {
        super(context);
        row = r;
        column = c;
        ...
        params.width = (int) getResources().getDisplayMetrics().density * 65;
        params.height = (int) getResources().getDisplayMetrics().density * 65;
