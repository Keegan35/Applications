...
public class Game5x6Medium extends AppCompatActivity implements View.OnClickListener{

    //Variables
    private int numberOfPictures;
    private MemoryButtonMedium[] buttons;
    private int[] buttonGraphicLocation;
    private int[] buttonGraphics;

    private MemoryButtonMedium selectedPicture1;
    private MemoryButtonMedium selectedPicture2;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_game5x6_medium);

        //Gets the gridlayout
        GridLayout gridLayout = (GridLayout)findViewById(R.id.grid_layout_5x6);

        int numColumns = gridLayout.getColumnCount();
        int numRows = gridLayout.getRowCount();

        numberOfPictures = numColumns * numRows;
        buttons = new MemoryButtonMedium[numberOfPictures];
        ...
        for(int r = 0; r < numRows; r++)
        {
            ...
            {
                MemoryButtonMedium picButton = new MemoryButtonMedium(this, r, c, buttonGraphics[ buttonGraphicLocation[r * numColumns + c] ]);
    ...
    public void onClick(View view) {
        ...
        MemoryButtonMedium button = (MemoryButtonMedium) view;
