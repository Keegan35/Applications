...
/**
 * Created by keegz_000 on 2017/03/27.
 */

public class MemoryButtonMedium extends Button
{
    //Variables
    protected int row;
    ...
    public MemoryButtonMedium(Context context, int r, int c, int frontImageDrawableId)
    {
        super(context);
        row = r;
        column = c;
        ...
        params.width = (int) getResources().getDisplayMetrics().density * 55;
        params.height = (int) getResources().getDisplayMetrics().density * 55;
